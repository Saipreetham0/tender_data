...
export const getStatusColor = (status: string) => {
  switch (status) {
    ...
    case "authenticated": return "bg-blue-100 text-blue-800 border-blue-200";
    case "pending": return "bg-yellow-100 text-yellow-800 border-yellow-200";
    case "halted": return "bg-red-100 text-red-800 border-red-200";
...
export const getFeatureIcon = (feature: string) => {
  ...
  if (feature.includes("alert") || feature.includes("notification")) return "Mail";
  ...
  if (feature.includes("Export") || feature.includes("Excel")) return "TrendingUp";
  return "CheckCircle";
};

type IconName = "Building2" | "Mail" | "Filter" | "Code" | "HeadphonesIcon" | "Clock" | "TrendingUp" | "CheckCircle";
